...
export const LoginForm: React.FC<LoginFormProps> = ({
  ...
  return (
    ...
    >
      {/* ✅ Company Logo + Name (fixed in corner) */}
      <div className="absolute top-6 left-6 flex items-center space-x-3 z-20">
        ...
        />
        <span className="text-[28px] font-bold text-slate-900 dark:text-white tracking-wide">
          SolarSync
        </span>
      </div>
      ...
      <motion.div
        ...
        className="z-10"
      >
        <Card className="w-[90vw] max-w-lg shadow-2xl rounded-3xl backdrop-blur-lg
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div>
                ...
                <Input
                  ...
                  required
                  disabled={isLoading}
                  className="mt-1 text-sm rounded-lg font-medium text-slate-800 dark:text-slate-100 
              ...
              >
                {isLoading
                  ? "Signing In..."
                  : `Sign In as ${userType === "installer" ? "Installer" : "Customer"}`}
              </Button>
            </form>
